...
//WARNING: 
// THIS STL LOADER SHOULD BE USED WITH CAUTION AS IT USES SCANF AND DOESN'T PROPERLY/SAFELY PARSE ALL POSSIBLE ASCII STL FILES.
// HOWEVER, IT GENERALLY WORKS FOR THE FILES THAT BLENDER PRODUCES WHEN TRIANGULATING AND EXPORTING A MESH TO THE ASCII STL FORMAT. 
